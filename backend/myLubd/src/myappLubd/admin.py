...
class WorkspaceReportAdmin(admin.ModelAdmin):
    ...
    def export_single_report_pdf(self, request, queryset):
        ...
        status_display = report.get_status_display() or report.status or 'N/A'
        priority_display = report.get_priority_display() or report.priority or 'N/A'
        topic_display = report.topic.name if report.topic else 'N/A'
        if report.custom_topic:
            topic_display = report.custom_topic
