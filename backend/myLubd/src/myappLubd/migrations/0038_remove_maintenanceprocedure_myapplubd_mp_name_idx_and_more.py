...
class RemoveFieldStateOnly(Operation):
    ...
    def database_forwards(self, app_label, schema_editor, from_state, to_state):
        # Intentionally do nothing - fields are removed via raw SQL above
        pass

    def database_backwards(self, app_label, schema_editor, from_state, to_state):
        # Not reversible because the columns were dropped already
        pass
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.SeparateDatabaseAndState(
            database_operations=[],  # DB columns removed via RunPython above
            state_operations=[
