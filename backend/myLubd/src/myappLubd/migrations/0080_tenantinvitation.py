# Generated by Django 5.2.14 on 2026-08-27 16:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(condition=models.Q(('accepted_at__isnull', True), ('revoked_at__isnull', True)), fields=('email',), name='unique_pending_invitation_email'), models.CheckConstraint(check=models.Q(models.Q(('accepted_at__isnull', True), ('accepted_by__isnull', True)), models.Q(('accepted_at__isnull', False), ('accepted_by__isnull', False)), _connector='OR'), name='invitation_acceptance_actor_consistent'), models.CheckConstraint(check=models.Q(('accepted_at__isnull', True), ('revoked_at__isnull', True), _connector='OR'), name='invitation_not_accepted_and_revoked')],
            },
        ),
    ]
