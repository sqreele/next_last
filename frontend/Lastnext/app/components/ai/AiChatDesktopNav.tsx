...
export default function AiChatDesktopNav() {
  ...
  return (
    <aside className="hidden desktop:flex desktop:w-[244px] desktop:flex-col desktop:border-r desktop:border-[var(--pcms-border)] desktop:bg-white/92 desktop:shadow-[var(--pcms-shadow-sm)] desktop:backdrop-blur-xl">
      ...
      <nav className="flex-1 overflow-y-auto px-2 py-4" aria-label="AI chat desktop navigation">
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    isActive ? 'bg-white/15 text-white' : 'bg-transparent text-slate-500 group-hover:text-slate-800',
                  )}
                >
