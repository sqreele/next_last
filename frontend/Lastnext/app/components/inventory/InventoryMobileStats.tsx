...
export function InventoryMobileStats({
  ...
  const tones = {
    primary: { card: 'border-blue-200 bg-blue-50/60', icon: 'bg-blue-600 text-white', value: 'text-blue-900' },
    success: { card: 'border-emerald-200 bg-emerald-50/60', icon: 'bg-emerald-600 text-white', value: 'text-emerald-900' },
    warning: { card: 'border-amber-200 bg-amber-50/60', icon: 'bg-amber-500 text-white', value: 'text-amber-900' },
    danger: { card: 'border-rose-200 bg-rose-50/60', icon: 'bg-rose-600 text-white', value: 'text-rose-900' },
    info: { card: 'border-indigo-200 bg-indigo-50/60', icon: 'bg-indigo-600 text-white', value: 'text-indigo-900' },
  } as const;

  return (
    <section aria-label="Inventory summary" className={cn('space-y-2', className)}>
          ...
          const content = (
            <>
              <div className="flex w-full items-center justify-between">
                <span className={cn('grid h-8 w-8 place-items-center rounded-xl', tone.icon)}>
