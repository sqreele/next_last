...
export default function CompletePreventiveMaintenance({
  params,
}: CompletePreventiveMaintenanceProps) {
  ...
  const [completionData, setCompletionData] =
    useState<CompletePreventiveMaintenanceData>({
      completion_notes: "",
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    if (selectedMaintenance?.scheduled_date) {
      ...
      const completionDate = completedDate
        ? new Date(completedDate)
        : new Date();

      const daysDiff = Math.floor(
        (completionDate.getTime() - scheduledDate.getTime()) /
          (1000 * 60 * 60 * 24),
      );
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-muted">
        {/* Mobile Header */}
        <div className="bg-card border-b border-border px-4 py-4 md:hidden">
        ...
        <div className="flex items-center justify-center py-12 md:py-20">
          <div className="text-center">
            ...
            <p className="mt-1 text-xs text-muted-foreground">ID: {pmId}</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="p-4 md:max-w-3xl md:mx-auto md:py-8 md:px-6 lg:px-8">
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            <Link
              ...
              className="inline-flex items-center bg-muted py-2 px-4 rounded-lg text-muted-foreground hover:bg-gray-200 text-sm"
            >
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                {successMessage.split("\n\n").map((line, index) => (
                  <p
                    key={index}
                    className={`text-sm md:text-base ${index > 0 ? "mt-2 font-semibold" : ""}`}
                  >
                    {line}
                  </p>
                ))}
        ...
        {selectedMaintenance &&
          ...
          !successMessage && (
            <div className="bg-card md:shadow md:rounded-lg mb-4 md:mb-6">
              ...
              <div className="border-t border-border px-4 py-4 md:py-5 md:px-6">
                <div className="space-y-3 md:grid md:grid-cols-2 md:gap-4 md:space-y-0">
                  <div>
                    ...
                    <dd className="mt-1 text-sm md:text-base text-foreground">
                  ...
                  <div>
                    ...
                    <dd className="mt-1 text-sm md:text-base text-foreground">
                      <span className="capitalize">
                        {selectedMaintenance.frequency.replace("_", " ")}
                      </span>
                    </dd>
                  </div>
              ...
              <div className="border-t border-border px-4 py-4 md:py-5 md:px-6">
                ...
                <div className="mb-6">
                  ...
                  <input
                    ...
                    disabled
                    className="w-full rounded-lg border border-border px-3 py-3 bg-muted text-muted-foreground text-sm md:text-base"
                  />
                  <p className="mt-2 text-xs text-muted-foreground">
                    The completion date will be automatically set when you
                    submit.
                  </p>
                </div>
                    ...
                    {(imagePreview || selectedMaintenance.after_image_url) && (
                      <div className="mt-2">
                        ...
                        <label
                          ...
                          className="inline-flex items-center px-3 py-2 border border-border rounded-lg text-sm text-muted-foreground bg-card hover:bg-muted cursor-pointer"
                        >
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Completed on:{" "}
                    {formatDate(selectedMaintenance.completed_date)}
                  </p>
                </div>
              </div>
            </div>
