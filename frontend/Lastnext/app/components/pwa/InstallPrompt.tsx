...
export function InstallPrompt() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-3 bottom-3 z-[80] mx-auto flex max-w-md items-center gap-3 rounded-xl border border-border bg-card p-3 shadow-card sm:bottom-6"
    ...
    >
      ...
      <button
        ...
        className="ml-1 grid h-8 w-8 place-items-center rounded-lg text-muted-foreground hover:bg-muted"
      >
        <X className="h-4 w-4" />
      </button>
    </div>
