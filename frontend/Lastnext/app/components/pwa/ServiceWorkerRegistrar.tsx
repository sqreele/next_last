...
export function ServiceWorkerRegistrar() {
  ...
  const watchForWaiting = useCallback((registration: ServiceWorkerRegistration) => {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed inset-x-3 bottom-24 z-[75] mx-auto flex max-w-md items-center gap-3 rounded-2xl border border-blue-200 bg-white p-3 shadow-2xl sm:bottom-6"
    ...
    >
      ...
      <button
        ...
        className="grid h-8 w-8 flex-none place-items-center rounded-lg text-slate-500 hover:bg-slate-100"
      >
        <X className="h-4 w-4" />
      </button>
    </div>
