...
export const metadata: Metadata = {
  title: 'Jobs by Area',
  description: 'Maintenance jobs grouped by their selected property area or zone.',
};
...
export default async function JobsByAreaPage() {
  ...
  return (
    <div className="w-full max-w-none space-y-5 px-3 py-4 sm:px-6 sm:py-5 lg:mx-auto lg:max-w-7xl">
      <Suspense fallback={<div className="text-sm text-slate-500">Loading jobs by area...</div>}>
