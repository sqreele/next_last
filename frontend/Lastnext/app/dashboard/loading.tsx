...
export default function DashboardLoading() {
  return (
    <div className="w-full max-w-none space-y-5 px-3 py-4 sm:px-6 sm:py-5 lg:mx-auto lg:max-w-7xl">
      <div className="flex flex-col gap-3 rounded-[18px] border border-[var(--pcms-border)] bg-white/90 p-5 backdrop-blur sm:flex-row sm:items-center sm:justify-between">
