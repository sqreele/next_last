...
export const MEDIA_CONFIG = {
  baseUrl: (() => {
    ...
    // Server-side: use NEXT_PUBLIC_MEDIA_URL or the canonical production origin.
    return process.env.NEXT_PUBLIC_MEDIA_URL || "https://staymaint.com";
  })(),
};
