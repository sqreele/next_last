...
export const metadata: Metadata = {
  title: 'Offline',
  description: 'You are currently offline. StayMaint will resume once your connection returns.',
      ...
      <div className="mx-auto flex max-w-md flex-col items-center gap-6 rounded-3xl border border-cyan-100 bg-white/85 p-8 shadow-xl backdrop-blur-sm">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm font-medium text-slate-600">
            StayMaint needs a connection to load fresh work orders. Cached pages remain available, and any
