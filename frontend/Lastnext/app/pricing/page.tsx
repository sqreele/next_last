...
const plans = [
  ...
  { code: "pro", name: "Pro", price: 30, popular: true, description: "For active hotel engineering teams that need preventive maintenance, reporting, and better operational visibility.", features: ["Everything in Basic", "Preventive maintenance", "PM schedules", "Technician KPI dashboard", "Advanced maintenance reports", "CSV export", "LINE / notification integration where supported", "Advanced team permissions", "Maintenance performance analytics", "Priority support"] },
  { code: "enterprise", name: "Enterprise", price: 60, popular: false, description: "For hotel groups and multi-property engineering operations that need centralized maintenance management.", features: ["Everything in Pro", "Multi-property management", "Centralized engineering dashboard", "Portfolio-level reporting", "Cross-property maintenance visibility", "Advanced user permissions", "Property-specific access controls", "Centralized KPI monitoring", "Assisted onboarding", "Priority support"] },
] as const;
