...
const nextConfig = {
  ...
  images: {
    ...
    remotePatterns: [
      ...
      // Production
      { protocol: 'https', hostname: 'staymaint.com', port: '', pathname: '/media/**' },
      { protocol: 'https', hostname: 'www.staymaint.com', port: '', pathname: '/media/**' },
      // Docker networking
    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Access-Control-Allow-Origin', value: process.env.AUTH0_BASE_URL || 'https://staymaint.com' },
